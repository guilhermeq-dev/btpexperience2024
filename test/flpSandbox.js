		...
		services: {
					...
					"config": {
						"groups": [{
							"tiles": [{
								...
								"properties": {
									"title": "BTP Experience 2024",
									"targetURL": "#comlab2devbtpexperience-display"
								}
							}]
						}]
					}
			...
			"ClientSideTargetResolution": {
				"adapter": {
					"config": {
						"inbounds": {
							"comlab2devbtpexperience-display": {
								"semanticObject": "comlab2devbtpexperience",
								"action": "display",
								...
								"resolutionResult": {
									...
									"additionalInformation": "SAPUI5.Component=com.lab2dev.btpexperience",
									"url": sap.ui.require.toUrl("com/lab2dev/btpexperience")
								}
							}
						}
					}
